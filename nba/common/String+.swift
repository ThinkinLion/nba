...
extension String {
    var nickNameToTriCode: String {
        ...
        case "76ers", "sixers", "philadelphia": return "PHI"
        case "blazers", "trail blazers", "portland": return "POR"
        case "bucks", "milwaukee": return "MIL"
        case "bulls", "chicago": return "CHI"
        case "cavaliers", "cavs", "cleveland": return "CLE"
        case "celtics", "boston": return "BOS"
        case "clippers", "la clippers": return "LAC"
        case "grizzlies", "memphis": return "MEM"
        case "hawks", "atlanta": return "ATL"
        case "heat", "miami": return "MIA"
        case "hornets", "charlotte": return "CHA"
        case "jazz", "utah": return "UTA"
        case "kings", "sacramento": return "SAC"
        case "knicks", "new york": return "NYK"
        case "lakers", "la lakers": return "LAL"
        case "magic", "orlando": return "ORL"
        case "mavericks", "dallas": return "DAL"
        case "nets", "brooklyn": return "BKN"
        case "nuggets", "denver": return "DEN"
        case "pacers", "indiana": return "IND"
        case "pelicans", "new orleans": return "NOP"
        case "pistons", "detroit": return "DET"
        case "raptors", "toronto": return "TOR"
        case "rockets", "houston": return "HOU"
        case "spurs", "san antonio": return "SAS"
        case "suns", "phoenix": return "PHX"
        case "thunder", "oklahoma city": return "OKC"
        case "timberwolves", "minnesota": return "MIN"
        case "warriors", "golden state": return "GSW"
        case "wizards", "washington": return "WAS"
        default: return ""
        }
    }
